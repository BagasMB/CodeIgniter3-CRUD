    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-md-10 mx-auto col-lg-6">
            <form action="" method="post" class="row g-3 p-4 p-md-5 border rounded-3 from shadow p-3 mb-5 bg-body-tertiary rounded">
                ...
                <p class="text-center text-muted" style="margin-top: -5px; margin-bottom:-5px;">Tambah Data.</p>
                <hr>
                <div class="col-12">
                    <label for="inputAddress2" class="form-label">Nis</label>
                    <input type="text" class="form-control" id="inputPassword4" placeholder="Nis" name="nis" autocomplete="off">
                    <i class="form-text">should be number 4</i>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary px-5 py-2" name="tambah">Save</button>
                    </div>
                </div>
            </form>
        </div>
